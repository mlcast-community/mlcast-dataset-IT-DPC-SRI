...
- From `DPC TIFF` to `Geotiff` (2025 onwards): dpc-tiff_to_geotiff.py re-encodes the raw TIFFs from the DPC FTP into the target GeoTIFF format (Float16, ZSTD, tiled, ODIM metadata).
